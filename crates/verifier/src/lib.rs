...
//!
//! By default, only the PLONK verifier is available (WASM-compatible).
//! Enable the `full` feature for Groth16, compressed proofs, and recursion VK support.
...
#[cfg(all(feature = "full", feature = "ark"))]
...
pub const VK_ROOT_BYTES: [u8; 32] = [
	0x00, 0x8c, 0xd5, 0x6e, 0x10, 0xc2, 0xfe, 0x24, 0x79, 0x5c, 0xff, 0x1e, 0x1d, 0x1f, 0x40,
	0xd3, 0xa3, 0x24, 0x52, 0x8d, 0x31, 0x56, 0x74, 0xda, 0x45, 0xd2, 0x6a, 0xfb, 0x37, 0x6e,
	0x86, 0x70,
];
